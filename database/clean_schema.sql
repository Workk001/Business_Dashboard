-- Clean Business Dashboard Database Schema
...
DROP POLICY IF EXISTS "Users can view their own password" ON user_passwords;
DROP POLICY IF EXISTS "Users can update their own password" ON user_passwords;
DROP POLICY IF EXISTS "Users can insert their own password" ON user_passwords;
...
DROP TRIGGER IF EXISTS trigger_set_bill_number ON bills;
...
DROP TRIGGER IF EXISTS trigger_update_bill_totals_items ON bill_items;
...
DROP TRIGGER IF EXISTS trigger_update_bill_totals_bills ON bills;
...
DROP TRIGGER IF EXISTS trigger_add_business_owner ON businesses;
